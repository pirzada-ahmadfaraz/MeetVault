  ...
  return (
    <div className="min-h-screen bg-slate-950 relative overflow-hidden">
      ...
      <div className="absolute top-6 left-6 z-10">
        <Link
          href="/"
          className="inline-flex items-center text-indigo-400 hover:text-indigo-300 transition-colors group bg-slate-900/80 backdrop-blur-sm px-3 py-2 rounded-lg border border-slate-800"
        >
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">Jump right back into your meetings and conversations</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">Your account is protected with enterprise-grade security</p>
                  </div>
                </div>
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-slate-400">Connect with your team and continue where you left off</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full max-w-lg mx-auto lg:mx-0">
              <div className="bg-slate-900 border border-slate-800 rounded-2xl shadow-2xl p-8">
                ...
                <div className="text-center mb-8 lg:hidden">
                  ...
                  <p className="text-slate-400">Sign in to continue to MeetVault</p>
                </div>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <UserIcon className={`h-5 w-5 transition-colors ${focusedField === 'identifier' ? 'text-indigo-400' : 'text-slate-500'}`} />
                      </div>
                      <input
                        id="identifier"
                        name="identifier"
                        ...
                        className="w-full pl-10 pr-10 py-2.5 border border-slate-700 bg-slate-800 rounded-lg placeholder-slate-500 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 text-sm"
                  ...
                  <div className="group">
                    ...
                    <div className="relative">
                      <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                        <LockClosedIcon className={`h-5 w-5 transition-colors ${focusedField === 'password' ? 'text-indigo-400' : 'text-slate-500'}`} />
                      </div>
                      <input
                        id="password"
                        name="password"
                        ...
                        onBlur={() => setFocusedField('')}
                        className="w-full pl-10 pr-4 py-2.5 border border-slate-700 bg-slate-800 rounded-lg placeholder-slate-500 text-white focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-indigo-500 transition-all duration-200 text-sm"
