      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="bg-gray-800 border border-gray-700 rounded-xl shadow-lg p-8 space-y-8">
          ...
          <section>
            ...
            <h3 className="text-lg font-semibold text-white mb-2">You MAY:</h3>
          ...
          {/* Disclaimer */}
          <section className="bg-orange-900/20 border border-orange-800/30 p-6 rounded-lg">
            <h2 className="text-xl font-bold text-orange-300 mb-2">Portfolio Project Disclaimer</h2>
