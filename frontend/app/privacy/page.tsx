    ...
    <div className="grain min-h-screen bg-ink text-fg">
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-14">
        ...
        <div className="text-center mb-12">
          <h1 className="font-display text-4xl font-extrabold mb-3">Privacy <span className="text-lime-400">Policy</span></h1>
          ...
          <section>
            ...
            <div className="rounded-xl border border-white/8 bg-white/[0.02] p-4">
              <p className="text-muted">
                <strong className="text-fg">Email:</strong> privacy@meetvault.demo<br/>
